...
const char* ssid = "Samsung Galaxy F12";                //replace with our wifi ssid
const char* password = "manoj051";         //replace with your wifi password

const char* host = "script.google.com";
const char *GScriptId = "AKfycbxzAP2f0EG21bkuGEnADn_UXfjgoEg5mbU6M9UMRN_ulwz3nl99VwOWFTDMVb2QZh4fFw"; // Replace with your own google script id
